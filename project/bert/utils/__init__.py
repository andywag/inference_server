...
def parse_bert_args(args_string=None):
    ...
    group.add_argument("--torch-checkpoint-link", type=str,
                       help="Path to Torch Checkpoint to initialise the model.")
    group.add_argument("--torch-checkpoint-name", type=str,
                       help="Path to Torch Checkpoint to initialise the model.")
